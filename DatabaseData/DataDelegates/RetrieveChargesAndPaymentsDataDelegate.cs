...
{
    public class RetrieveChargesAndPaymentsDataDelegate : DataReaderDelegate<IReadOnlyList<Transaction>>
    {
        private readonly int _personID;

        public RetrieveChargesAndPaymentsDataDelegate(int personID)
            : base("People.RetrieveChargesAndPayments")
        {
            _personID = personID;
        }
